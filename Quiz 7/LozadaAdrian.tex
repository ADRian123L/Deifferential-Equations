...
\end{align*}
    ...
    $$= A(s^{3} - s) + B(s^{2} - 1) + C(s^{3} + s^{2}) + D(s^{3} - s^{2})$$ $$= As^{3} - As + Bs^{2} - B + Cs^{3} + Cs^{2} + Ds^{3} - Ds^{2}$$ $$s^{3}(A + D) + s^{2}(B + C - D) + s(-A) - B$$ $$A + C + D = 3; B + C - D = 0; -A = 0; -B = 1$$ $$A = 0;\quad B = -1;\quad C = 2;\quad D = 1$$ \text{Hence,} $$\frac{1 + 3s^{2}}{s^{2}(s + 1)(s - 1)} = -\frac{1}{s^{2}} + \frac{2}{s - 1} + \frac{1}{s + 1}$$ \\
